...
public class GraWindow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // pobieamy dane gracza z bazy danych
        getNameAndScore();
...
// -------------------------------------  KONIEC SIECI NEURONOWEJ ----------------------------------------------
    public void gamePhisics(){
        ...
        if (poziomTrudnosciZadan == 1) {
            ...
            listaZadan.add("Rozwiąż równanie x + 5 = 12");
            listaOdpowiedziZad.add(7f);
            listaZadan.add("Rozwiąż równanie 2x - 3 = 7");
            listaOdpowiedziZad.add(5f);
            listaZadan.add("Oblicz pole rombu o przekątnych długości 6 i 8");
            listaOdpowiedziZad.add(24f);
            listaZadan.add("Oblicz wartość wyrażenia (2^3 - 4) * 5");
            listaOdpowiedziZad.add(20f);
            listaZadan.add("Oblicz wartość wyrażenia 3^2 - 4");
            listaOdpowiedziZad.add(5f);
            listaZadan.add("12^2");
            listaOdpowiedziZad.add(144f);
            listaZadan.add("2+2*2");
            listaOdpowiedziZad.add(6f);
            listaZadan.add("x+2=5");
            listaOdpowiedziZad.add(3f);
            listaZadan.add("0*3");
            listaOdpowiedziZad.add(0f);
            listaZadan.add("2^3*2");
            listaOdpowiedziZad.add(16f);
        } else if (poziomTrudnosciZadan == 4){
            listaZadan.add("Rozwiąż równanie 2x + 5 = 17");
            listaOdpowiedziZad.add(6f);
            listaZadan.add("Oblicz pierwiastek kwadratowy z liczby 81");
            listaOdpowiedziZad.add(9f);
            listaZadan.add("Oblicz iloraz liczb 36 i 12");
            listaOdpowiedziZad.add(3f);
            listaZadan.add("Oblicz pole kwadratu o boku długości 5");
            listaOdpowiedziZad.add(5f);
            listaZadan.add("Oblicz objętość sześcianu o boku długości 3");
            listaOdpowiedziZad.add(27f);
            listaZadan.add("Oblicz różnicę między liczbami 10 i 3");
            listaOdpowiedziZad.add(7f);
            listaZadan.add("Oblicz wartość wyrażenia 2^4");
            listaOdpowiedziZad.add(16f);
            listaZadan.add("Oblicz obwód trójkąta o bokach długości 6, 8 i 10");
            listaOdpowiedziZad.add(24f);
            listaZadan.add("Oblicz iloczyn liczb 5 i 1");
            listaOdpowiedziZad.add(5f);
            listaZadan.add("Oblicz różnicę między liczbami 15 i 8");
            listaOdpowiedziZad.add(7f);
        } else if (poziomTrudnosciZadan == 5){
            listaZadan.add("Oblicz pole prostokąta o bokach długości 9 i 4");
            listaOdpowiedziZad.add(36f);
            listaZadan.add("Oblicz pierwiastek kwadratowy z liczby 144");
            listaOdpowiedziZad.add(12f);
            listaZadan.add("Oblicz iloraz liczb 64 i 8.");
            listaOdpowiedziZad.add(8f);
            listaZadan.add("Oblicz pole kwadratu o boku długości 7");
            listaOdpowiedziZad.add(49f);
            listaZadan.add("Oblicz objętość sześcianu o boku długości 5");
            listaOdpowiedziZad.add(125f);
            listaZadan.add("blicz różnicę między liczbami 20 i 9");
            listaOdpowiedziZad.add(11f);
            listaZadan.add("Oblicz obwód trójkąta o bokach długości 12, 15 i 18");
            listaOdpowiedziZad.add(45f);
            listaZadan.add("licz iloczyn liczb 6 i 4");
            listaOdpowiedziZad.add(24f);
            listaZadan.add("blicz sumę liczb 27 i 13");
            listaOdpowiedziZad.add(40f);
            listaZadan.add("5*5*5^2");
            listaOdpowiedziZad.add(625f);
        } else if (poziomTrudnosciZadan == 6){
            listaZadan.add("Rozwiąż równanie log₅(x + 3) = 2");
            listaOdpowiedziZad.add(22f);
            listaZadan.add("Oblicz pole trapezu o podstawach długości 6 i 9, oraz wysokości 4");
            listaOdpowiedziZad.add(30f);
            listaZadan.add("Oblicz sumę nieskończonego ciągu arytmetycznego o pierwszym wyrazie 3, różnicy 2 i stosunku sumy do pierwszego wyrazu równego 4");
            listaOdpowiedziZad.add(12f);
            listaZadan.add("Rozwiąż równanie log₄(x² + 4) = 3");
            listaOdpowiedziZad.add(2f);
            listaZadan.add("Oblicz pierwiastek kwadratowy z liczby 144/169, zaokrąglając wynik do najbliższej setnej");
            listaOdpowiedziZad.add(0.85f);
            listaZadan.add("Oblicz pole równoległoboku o bokach długości 5 i 7, oraz kącie między nimi równym 120 stopni");
            listaOdpowiedziZad.add(17.5f);
            listaZadan.add("blicz objętość ostrosłupa prawidłowego czworokątnego o podstawie trapezu o długości podstaw 5 i 7, oraz wysokości 4");
            listaOdpowiedziZad.add(80f);
            listaZadan.add("Oblicz wartość wyrażenia log₁₀(1000) - log₂(8)");
            listaOdpowiedziZad.add(0f);
            listaZadan.add("Rozwiąż równanie log₄(x + 1) = 2");
            listaOdpowiedziZad.add(15f);
            listaZadan.add("Oblicz pierwiastek trzeciego stopnia z liczby 125");
            listaOdpowiedziZad.add(5f);
        } else if (poziomTrudnosciZadan == 7){
            listaZadan.add("Oblicz pole trójkąta równoramiennego o bokach długości 6, 6 i 8.");
            listaOdpowiedziZad.add(18f);
            listaZadan.add("Oblicz pole trójkąta o bokach długości 8, 9 i 12, używając wzoru Herona");
            listaOdpowiedziZad.add(35.97f);
            listaZadan.add("Oblicz objętość ostrosłupa prawidłowego czworokątnego o podstawie trapezu o długości podstaw 6 i 8, oraz wysokości 4");
            listaOdpowiedziZad.add(96f);
            listaZadan.add("Oblicz wartość wyrażenia log₃(27");
            listaOdpowiedziZad.add(3f);
            listaZadan.add("Oblicz pierwiastek kwadratowy z liczby 121.");
            listaOdpowiedziZad.add(11f);
            listaZadan.add("Oblicz pole trójkąta o bokach długości 9, 12 i 15, używając wzoru Herona");
            listaOdpowiedziZad.add(54f);
            listaZadan.add("Oblicz sumę nieskończonego ciągu geometrycznego o pierwszym wyrazie 2 i ilorazie 1/2");
            listaOdpowiedziZad.add(4f);
            listaZadan.add("Oblicz pierwiastek czwarty stopnia z liczby 625");
            listaOdpowiedziZad.add(5f);
            listaZadan.add("Oblicz iloczyn liczb 8 i 7");
            listaOdpowiedziZad.add(56f);
            listaZadan.add("Oblicz sumę liczb całkowitych od 1 do 10");
            listaOdpowiedziZad.add(55f);
        } else if (poziomTrudnosciZadan == 8){
            listaZadan.add("Oblicz pole trapezu o przekątnych długości 6 i 8");
            listaOdpowiedziZad.add(24f);
            listaZadan.add("Oblicz sumę nieskończonego ciągu arytmetycznego o pierwszym wyrazie 3, różnicy 2 i stosunku sumy do pierwszego wyrazu równego 4");
            listaOdpowiedziZad.add(12f);
            listaZadan.add("Oblicz pole trapezu o podstawach długości 6 i 9, oraz wysokości 4");
            listaOdpowiedziZad.add(45f);
            listaZadan.add("Oblicz sumę liczb całkowitych od 1 do 100");
            listaOdpowiedziZad.add(5050f);
            listaZadan.add("Oblicz różnicę między kwadratem liczby 10 a liczbą 17");
            listaOdpowiedziZad.add(83f);
            listaZadan.add("Oblicz iloraz liczb 80 i 8");
            listaOdpowiedziZad.add(10f);
            listaZadan.add("Oblicz wartość wyrażenia 3! + 5");
            listaOdpowiedziZad.add(11f);
            listaZadan.add("Oblicz pole trójkąta o bokach długości 5, 12 i 13, używając wzoru Herona");
            listaOdpowiedziZad.add(30f);
            listaZadan.add("Oblicz sumę liczb parzystych od 2 do 100");
            listaOdpowiedziZad.add(2550f);
            listaZadan.add("Oblicz wartość wyrażenia 4^3 - 2^5");
            listaOdpowiedziZad.add(32f);
        } else if (poziomTrudnosciZadan == 9){
            listaZadan.add("Oblicz pierwiastek piątego stopnia z liczby 32");
            listaOdpowiedziZad.add(2f);
            listaZadan.add("Oblicz iloczyn liczb pierwszych 13 i 19");
            listaOdpowiedziZad.add(81f);
            listaZadan.add("Oblicz sumę liczb całkowitych od 1 do 1000");
            listaOdpowiedziZad.add(500500f);
            listaZadan.add("Oblicz różnicę między sześcianem liczby 12 a liczbą 57");
            listaOdpowiedziZad.add(333f);
            listaZadan.add("Oblicz pierwiastek kwadratowy z liczby 196");
            listaOdpowiedziZad.add(14f);
            listaZadan.add("Oblicz iloraz liczb 200 i 10");
            listaOdpowiedziZad.add(20f);
            listaZadan.add("Oblicz wartość wyrażenia 5! - 3^2");
            listaOdpowiedziZad.add(117f);
            listaZadan.add("Oblicz sumę liczb nieparzystych od 1 do 100");
            listaOdpowiedziZad.add(2500f);
            listaZadan.add("Oblicz wartość wyrażenia log₇(49");
            listaOdpowiedziZad.add(2f);
            listaZadan.add("Oblicz pole trójkąta o bokach długości 10, 12 i 15, używając wzoru Herona");
            listaOdpowiedziZad.add(54f);
        } else if (poziomTrudnosciZadan == 10){
            listaZadan.add("Oblicz pierwiastek trzeciego stopnia z liczby 64");
            listaOdpowiedziZad.add(4f);
            listaZadan.add("Oblicz wartość wyrażenia 6! - 5^3. ");
            listaOdpowiedziZad.add(576f);
            listaZadan.add("Oblicz różnicę między kwadratem liczby 15 a liczbą 82");
            listaOdpowiedziZad.add(23f);
            listaZadan.add("Oblicz pierwiastek czwartego stopnia z liczby 625.");
            listaOdpowiedziZad.add(5f);
            listaZadan.add("Oblicz wartość wyrażenia log₂(32) - log₂(2)");
            listaOdpowiedziZad.add(4f);
            listaZadan.add("Oblicz pole trapezu o długości podstaw 8 i 12 oraz wysokości 5");
            listaOdpowiedziZad.add(50f);
            listaZadan.add("Oblicz pierwiastek kwadratowy z liczby 14400");
            listaOdpowiedziZad.add(120f);
            listaZadan.add("Oblicz sumę liczb całkowitych parzystych od 2 do 200");
            listaOdpowiedziZad.add(10100f);
            listaZadan.add("Oblicz pole rombu o przekątnych długości 10 i 12");
            listaOdpowiedziZad.add(60f);
            listaZadan.add("Oblicz pierwiastek drugiego stopnia z liczby 196");
            listaOdpowiedziZad.add(14f);
        }
        ...
        if (numerZadaniaZadania<10) {
            ...
            if (listaZadan.get(numerZadaniaZadania).length() > 10) {
                textViewOperacja.setTextSize(20);
            } else {
                textViewOperacja.setTextSize(50);
            }
